...
#define USBD_MANUFACTURER_STRING        (uint8_t*)("Neil Lab :: LeftRadio")

#define USBD_PRODUCT_FS_STRING          (uint8_t*)("Neil T11 HQ Audio (FS Mode)")
#define USBD_PRODUCT_HS_STRING          (uint8_t*)("Neil T11 HQ Audio (HS Mode)")
...
/* USB UAC2 Device Qualifier Descriptor */
__ALIGN_BEGIN uint8_t USBD_DeviceQualifierDesc[USB_LEN_DEV_QUALIFIER_DESC] __ALIGN_END =
      {
          USB_LEN_DEV_QUALIFIER_DESC,
          USB_DESC_TYPE_DEVICE_QUALIFIER,

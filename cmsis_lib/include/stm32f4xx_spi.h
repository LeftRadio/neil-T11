...
typedef struct
{
  ...
  uint16_t I2S_MCLK_External;   /*!< Specifies whether the external I2S MCLK input is enabled or not.
                                    This parameter can be a value of @ref I2S_MCLK_External */
...
/** @defgroup SPI_I2S_MCLK_External
  * @{
  */

#define I2S_MCLKExternal_Enable           ((uint16_t)0x0001)
#define I2S_MCLKExternal_Disable          ((uint16_t)0x0000)
